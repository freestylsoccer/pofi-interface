...
export default function Theter() {
  ...
  const [data] = useReserveData(PROJECT_USDT)
  ...
  return (
    <Container id="pp1-page" className="py-20 md:py-12 lg:py-20" maxWidth="full">
      ...
      <div className="px-4 py-4 md:px-8" id="Overview">
      ...
      <div className="container max-w-3xl mx-auto" id="Strategy">
      ...
      <div className="container mx-auto text-center" id="Performance">
        <div className="p-3">
